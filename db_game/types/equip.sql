CREATE TABLE equipping_type (
  ...
  applicable    VARCHAR(64),         /* прменимо к своим "my_units", вражеским "hostile_units", всем "all",  карте "map", на себя "myself", на себя перемещение "myself_move", "mining" - добыча ресурсов */
  ...
  y_attach      INT,                 /* точка крепления эквипа к точке крепления корпуса, по сути центр эквипа */
  x_attach      INT                  /* точка крепления эквипа к точке крепления корпуса, по сути центр эквипа */
);
