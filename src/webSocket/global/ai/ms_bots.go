...
//	possible, _ := collisions.CheckCollisionsOnStaticMap(toX, toY, 0, mp, bot.GetSquad().MatherShip.Body, true, false)
//	if possible {
//
//		go func() {
//			for bot.InBaseID == 0 {
...
//		&coordinate.Coordinate{X: toX, Y: toY}, bot.GetSquad().MatherShip, scale, allUnits, "", nil)
//
//	if len(path) == 0 {
