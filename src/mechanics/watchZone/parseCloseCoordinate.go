...
func parseCloseCoordinate(closeCoordinates []*coordinate.Coordinate, closeUnit []*unit.Unit, closeMatherShip []*matherShip.MatherShip, game *game.Game) ([]*coordinate.Coordinate) {
