...
game.load.image('1543229332140825449', 'http://' + window.location.host + '/assets/map/terrain/1543229332140825449.png'); 
game.load.image('1543229332140825449', 'http://' + window.location.host + '/assets/map/objects/1543229332140825449.png'); 
game.load.spritesheet('256_256', 'http://' + window.location.host + '/assets/map/animate/256_256.png', 256,256,60); 
