function choiceFraction() {
    ...
    <div>
        <div class="fraction">
             <h3>Replics</h3>
             <div style="background-image: url('../assets/dialogPictures/replics_logo.png'); box-shadow: 0 0 15px red"></div>
        ...
        <div class="fraction">
             <h3>Explores</h3>
             <div style="background-image: url('../assets/dialogPictures/explores_logo.png'); box-shadow: 0 0 15px greenyellow"></div>
        ...
        <div class="fraction">
             <h3>Reverses</h3>
             <div style="background-image: url('../assets/dialogPictures/reverses_logo.png'); box-shadow: 0 0 15px deepskyblue"></div>
