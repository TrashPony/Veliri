        ...
        if (coordinates.hasOwnProperty(q)) {
            for (let r in coordinates[q]) {
                if (coordinates[q].hasOwnProperty(r)) {
                    ...
                    let selectSprite = MarkZone(cellSprite, coordinates, coordinates[q][r].q, coordinates[q][r].r, 'Place', true, game.SelectTargetLineLayer, "place", game.SelectLayer, true);
